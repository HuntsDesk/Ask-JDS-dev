  ...
  if (cards.length === 0) {
    return (
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          <Link to="/sets" className="text-indigo-600 hover:text-indigo-700">
            ← Back to Collections
          </Link>
    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="text-right">
          <Link to={`/subject/${collection.subject.id}`} className="text-indigo-600 font-medium mb-2 hover:underline block">
